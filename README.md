...
- **Lints**: ESLint (eslint-config-next)
...
Dự án được chia thành 3 module độc lập: `frontend`, `frontend-web` và `backend`.
...
│
├── frontend-web/             # Mã nguồn web app (Next.js)
│   ├── app/                  # App Router routes
│   ├── src/                  # Components và libs riêng cho web
│   ├── package.json          # Scripts và dependencies web
